...
/* ---------- Subsolapas de Configuración: Productos / Supermercados ---------- */
...
function activarSubtabConfiguracion(subtab) {
  ...
  const esProductos = subtab === "productos";
  btnSubtabProductos.classList.toggle("subtab-btn--activo", esProductos);
  btnSubtabSupermercados.classList.toggle("subtab-btn--activo", !esProductos);
  panelProductos.classList.toggle("oculto", !esProductos);
  panelSupermercados.classList.toggle("oculto", esProductos);

  if (esProductos) renderProductos(panelProductos);
  else renderSupermercados(panelSupermercados, () => {});
}
